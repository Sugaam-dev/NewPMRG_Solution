      ...
      <main className="w-full bg-white">
        ...
        <section className="py-10 bg-white">
          <div className="max-w-[1600px] mx-auto px-10">
            ...
            {/* ========================================================= */}
            {/* FINAL FIXED GREEN BOX — EXACT MATCH TO FIRST IMAGE      */}
            {/* ========================================================= */}

            <div className="mt-16 w-full flex justify-center">
              <div className="bg-[#F5F7EB] rounded-[40px] py-20 px-20 max-w-[1600px] w-full">

                <div className="grid md:grid-cols-3 gap-28 text-left">
                  ...
                  <div className="flex flex-col">
                    ...
                    <p className="text-[18px] leading-[1.9] text-[#333]">
                      Both platforms maintain real-time synchronization ensuring consistency. Customer signup in PMRGMobi triggers
                       instant provisioning in PMRGEnable, plan changes update both systems simultaneously, usage data flows continuously
                        from network to billing, and service status remains synchronized across platforms.
                       Real-time sync prevents data inconsistencies frustrating customers and operators.
                    </p>
                  </div>
                  ...
                  <div className="flex flex-col">
                    ...
                    <p className="text-[18px] leading-[1.9] text-[#333]">
                      Integration creates seamless customer experience across touchpoints. Self-service portals access both billing and network functions,
                       plan changes take effect immediately on network and billing, usage monitoring shows real-time network data, and customer 
                      service sees complete information spanning both platforms. Customers experience one integrated service.
                    </p>
                  </div>
                  ...
                  <div className="flex flex-col">
                    ...
                    <p className="text-[18px] leading-[1.9] text-[#333]">
                      Integrated operations reduce operational complexity significantly. Single customer onboarding process spans both platforms,
                       automated workflows cross platform boundaries seamlessly, unified reporting provides complete business visibility, 
                      and coordinated support resolves issues faster. Operations teams work more efficiently with integrated systems.
                    </p>
                  </div>
        ...
        <section className="py-5 bg-white">
          <div className="text-center max-w-4xl mx-auto px-6">
            ...
            <p className="mt-6 text-[20px] leading-[1.7] font-['Mona Sans',Helvetica,Arial,sans-serif]">
              Integration accelerates launching new mobile services dramatically. Configure services once affecting both platforms, 
              test end-to-end customer journeys comprehensively, launch new offerings in hours instead of weeks, 
              and modify services quickly as markets evolve. Speed to market provides competitive advantage.
            </p>
            ...
            <div className="max-w-[1700px] mx-auto px-5 grid md:grid-cols-2 gap-20 items-center">
              ...
              <div className="flex flex-col justify-center max-w-[650px]">
                ...
                <p className="mt-6 text-[20px] leading-[1.8] font-['Mona Sans',Helvetica,Arial,sans-serif] text-[#333]">
                  ...
                  telecommunications experience. Partnership provides complete solution with expert
        ...
        <section className="py-5 bg-white">
            <div className="text-center max-w-[1600px] mx-auto px-10">
              ...
              {/* FIXED PARAGRAPH – EXACT FIRST IMAGE WIDTH + SPACING */}
              <p className="mt-8 text-[20px] leading-[1.8] max-w-[1100px] mx-auto font-['Mona Sans',Helvetica,Arial,sans-serif] text-[#333]">
                ...
                with other MVNEs. Open APIs support connections to any MVNE platform, standard protocols 
                enable common integration patterns, and experienced integration team supports 
                implementations. PMRGMobi works with your preferred MVNE partner while providing 
                smoothest experience with PMRGEnable.
              </p>
