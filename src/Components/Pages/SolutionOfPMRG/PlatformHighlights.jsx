...
//         <div className="w-full bg-white pt-20 pb-24">
...
//             <div>
//               <h2
//                 className="text-[48px] font-semibold mb-5"
...
//             {/* ------------------ NEW CARD SECTION (Matches PERFECT DESIGN) ------------------ */}
...
//                   processing handles multiple payment methods and currencies.
//                   Automated dunning manages overdue accounts intelligently.
//                   Provisioning integrates with MVNEs for instant service activation.
//                   Automation enables lean, efficient operations.
//                 </p>
//               </div>
...
//                   operators. Customers monitor consumption and avoid bill shock.
//                   Operators identify trends and anomalies immediately. Real-time
//                   rating calculates charges as usage occurs. Proactive management
//                   becomes possible with always-available data.
//                 </p>
//               </div>
...
//                   API-first approach enables extensive integration capabilities.
//                   Modern technology stack ensures high performance and strong
//                   supportability. Architecture supports long-term evolution without
//                   legacy compromises.
//                 </p>
//               </div>
//             </div>
...
//           {/* ------------------ PROVEN RELIABILITY ------------------ */}
//           <div className="max-w-5xl mx-auto px-6 mt-24 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">

//             {/* LEFT CONTENT */}
//             <div>
//               <h2 className="text-2xl font-semibold mb-4">Proven Reliability</h2>
//               <p className="text-gray-700 leading-relaxed">
//                 Despite modern architecture, CleverMobi delivers proven reliability
//                 supporting thousands of customers across multiple mobile operations.
//                 Robust error handling and strict data validation prevent issues.
//                 Comprehensive monitoring detects problems quickly, enabling recovery
//                 mechanisms to minimize disruption. Innovation meets dependability.
//               </p>
//             </div>
